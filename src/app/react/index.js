...
export default function ReactTopicsDashboard() {
  ...
  const progressStats = useMemo(() => {
    const totalItems = reactTopics.topics.reduce(
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    headline: "React Developer Learning Path | DevCodeEx",
    description:
      "Master React development with our comprehensive learning path covering React fundamentals, hooks, state management, and more.",
    keywords:
      "React, React Hooks, State Management, Redux, Next.js, Component Design, Testing, Performance Optimization, Web Development",
    ...
    mainEntity: reactTopics.topics.map((topic) => ({
      "@type": "Course",
      name: topic.title,
  ...
  return (
    <Layout
      title="React Developer Learning Path | DevCodeEx"
      description="Master React with our comprehensive learning path covering React fundamentals, hooks, state management, and more."
    ...
    >
      <Head>
        <meta
          name="keywords"
          content="React, React Hooks, State Management, Redux, Next.js, Component Design, Testing, Performance Optimization, Web Development"
        />
        <meta
          name="description"
          content="Master React with our comprehensive learning path covering React fundamentals, hooks, state management, and more."
        />
        <meta property="og:title" content="React Developer Learning Path | DevCodeEx" />
        <meta
          property="og:description"
          content="Master React with our comprehensive learning path covering React fundamentals, hooks, state management, and more."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://devexcode.com/react" />
        <meta property="og:image" content="https://devexcode.com/react-learning-path.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="React Developer Learning Path | DevCodeEx" />
        <meta
          name="twitter:description"
          content="Master React with our comprehensive learning path covering React fundamentals, hooks, state management, and more."
        />
        <meta name="twitter:image" content="https://devexcode.com/react-learning-path.png" />
        <link rel="canonical" href="https://devexcode.com/react" />
        <script
      ...
      <div className="bg-gradient-to-b from-gray-50 to-gray-100 dark:from-slate-900 dark:to-slate-800 min-h-screen overflow-x-hidden">
        {/* Hero Section */}
        <header className="max-w-7xl mx-auto px-0 sm:px-6 lg:px-8 pt-0 pb-8">
          <motion.div
          ...
          >
            <div className="w-full sm:w-auto">
              ...
              <p className="mt-2 text-base sm:text-lg text-gray-600 dark:text-gray-300">
                Master React with our expertly curated learning path, covering fundamentals, hooks, state management, and more.
              </p>
            </div>
