...
export default function Top100LikedClient({ top100liked, totalQuestions }) {
  ...
  const top100Ids = new Set(
    top100liked.sections.flatMap((section) =>
      ...
      <main className="bg-gray-50 dark:bg-slate-900 min-h-screen pt-20 pb-20">
        <section className="py-20 bg-indigo-600">
           <div className="max-w-7xl mx-auto px-4 text-center text-white">
             <h1 className="text-4xl sm:text-6xl font-black mb-6">Top 100 Liked Questions</h1>
             <p className="text-indigo-100 text-lg sm:text-xl max-w-2xl mx-auto mb-10">
               Hand-picked questions by the community for coding interview preparation.
             </p>
             {isLoggedIn && (
        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4">
            {top100liked.sections.map((section) => {
              ...
              return (
                <div key={section.slug} className="mb-12">
                  <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                     <span className="w-8 h-8 rounded-lg bg-indigo-600 text-white flex items-center justify-center text-xs font-black">100</span>
                     {section.name}
                  </h2>
