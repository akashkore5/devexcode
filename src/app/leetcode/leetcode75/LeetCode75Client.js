...
export default function LeetCode75Client({ leetcode75, totalQuestions }) {
      ...
      <main className="bg-gray-50 dark:bg-slate-900 min-h-screen pt-20">
        <section className="py-20 bg-indigo-600">
           <div className="max-w-7xl mx-auto px-4 text-center">
             ...
             <motion.p variants={heroVariants} initial="hidden" animate="visible" transition={{delay:0.1}} className="text-indigo-100 text-lg sm:text-xl max-w-2xl mx-auto mb-10">
               Essential coding problems for technical interview preparation.
             </motion.p>
             {isLoggedIn && (
        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4">
            {leetcode75.sections.map((section) => {
              ...
              return (
                <div key={section.slug} className="mb-12">
                  <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                     <span className="w-8 h-8 rounded-lg bg-indigo-600 text-white flex items-center justify-center text-xs font-black">75</span>
                     {section.name}
                  </h2>
