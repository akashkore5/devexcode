...
export default function DailyTermDetail({ initialTerm, previousTerms }) {
  ...
  const handleDateChange = (value) => {
    ...
    if (formattedDate <= today) {
      ...
      router.push(`/daily-term/${formattedDate}`);
    } else {
  ...
  return (
    <>
      ...
      <section className="pt-28 pb-12 bg-gray-50 dark:bg-slate-900 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            locale="en-GB"
            className="border-none shadow-none w-full dark:bg-slate-800 dark:text-white"
