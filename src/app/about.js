...
export default function About() {
  ...
  return (
    <Layout
      title="About DevExCode - Your Partner in Coding Interview Success"
      description="Learn about DevExCode’s mission to empower 15,000+ coders with Leetcode solutions, system design guides, daily technical terms, and a vibrant community led by developers Akash Kore, Vipul Sukhdeve, and Yogesh Pandav."
    >
